      ...
      <div className="relative h-screen">
        ...
        <nav className="relative z-10 flex items-center justify-between p-6">
          ...
          <div>
            ...
            <pre className='text-white font-mono font-bold text-xl'> News at Your Fingertips</pre>
            </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center pt-32 px-4">
          <div className="bg-yellow-950 backdrop-opacity-75 p-10 rounded-lg">
            <h1 className="text-5xl font-bold text-white mb-6">Your World of News in One Place</h1>
